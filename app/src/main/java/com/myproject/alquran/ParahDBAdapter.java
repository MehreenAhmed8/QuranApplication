...
public class ParahDBAdapter extends SQLiteAssetHelper {
    ...
    public ParahDBAdapter(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    public List<AayaatModel> getParahList(int parahId) throws
            SQLException {
        SQLiteDatabase db = getReadableDatabase();
        List<AayaatModel> orderDetailList = new ArrayList<>();
        String queryFromAayaatTable = "SELECT * FROM " + TABLE_AAYAAT + " WHERE paraId=" + parahId;
